      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white">Mesas y sillas</a></li>
              <li><a href="#" className="hover:text-white">Decoración</a></li>
              <li><a href="#" className="hover:text-white">Sonido e iluminación</a></li>
              <li><a href="#" className="hover:text-white">Carpas y toldos</a></li>
              <li><a href="#" className="hover:text-white">Menaje y vajilla</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <Map className="h-6 w-6 mr-2 mt-0.5" />
            ...
            <h3 className="text-lg font-semibold text-white mt-6 mb-4">Horario de atención</h3>
